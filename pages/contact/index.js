...
import location from '../../assets/locationandarea.png'
        ...
        <>
            ...
            <main>
                ...
                <section className={`${styles.main_bg}`}>
                    <div className={`${styles.main_bgShadow}`}>
                        <div className="flex justify-start items-center flex-wrap gap-2 my-6">
                            <h1 className="text-[#FF6B00] text-4xl font-bold">Contact</h1>
                            <h1 className=" text-4xl font-bold text-white">Us</h1> <div>
                            </div>
                        </div>
                    </div>
                </section>
                <section className='p-5 md:10 xl:p-20'>
                    <div>
                        <div className='flex justify-between items-center gap-20 mb-20'>
                            <div className='flex-1'>
                                <h1 className='mb-3 text-2xl font-bold text-[#FF6B00]'>Sparrowan LLC.(Headquarter)</h1>
                                <p className='text-sm'>
                                    United States of America
                                    4400 W Sample RD.
                                    Suite # 102,
                                    Coconut Creek
                                    FL-33073, United State

                                </p>
                                <p className='my-5'>contact@sparrowan.com</p>
                                <div className='flex justify-start items-center gap-3'>
                                    <span>Tel : </span>
                                    <span className='text-xl text-[#FF6B00]'> +1 (954) 449-5289</span>
                                </div>

                            </div>
                            <div className='flex-1'>
                                <Image className='w-[300px] mx-auto rounded' src={location} width={100} height={100} alt='Location Images ' />
                            </div>
                        </div>
                        <div className='flex justify-between items-center gap-20 mb-20'>
                            <div className='flex-1'>
                                <h1 className='mb-3 text-2xl font-bold text-[#FF6B00]'>Sparrowan LTD.(Bangladesh Office)</h1>
                                <p className='text-sm'>
                                    House # 193, Road # 2, Avenue # 3,
                                ...
                                <div className='flex justify-start items-center gap-3'>
                                    <span>Tel : </span>
                                    <span className='text-xl text-[#FF6B00]'>+8801717282234</span>
                                </div>
                        ...
                        <div className='flex justify-between items-center gap-20 mb-10'>
                            <div className='flex-1'>
                                <h1 className='mb-3 text-2xl font-bold text-[#FF6B00]'>Sparrowan LLC.(UK Office)
                                </h1>
                                <p className='text-sm'>
                                    United Kingdom
                                    275 New N Rd Ste 3087
                                    London, N1 7AA
                                </p>
                                <p className='my-5'>contact@sparrowan.com</p>
                                <div className='flex justify-start items-center gap-3'>
                                    <span>Tel : </span>
                                    <span className='text-xl text-[#FF6B00]'> +44 (204) 577-0819</span>
                                </div>
