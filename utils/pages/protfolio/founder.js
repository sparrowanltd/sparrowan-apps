    ...
    return (
        <>
            <div className="text-center my-10">
                <span className="text-[#FF6B00] bg-[#FFE1CC] py-2 px-3 font-bold">Founder</span>
            </div>
            <section className="grid grid-cols-3  gap-10 ">
                {
                    founderInfo.map(data =>
                        <div key={data.id} className="w-[340px] h-[400px]  relative mx-auto rounded shadow-[0_3px_10px_rgb(0,0,0,0.2)]">
                            <div className=" p-4">
                                <div className="my-2">
                                    <Image className="w-[100px] h-[100px] rounded-full mx-auto" src={data.images} width={100} height={100} alt="founder images " />
                                </div>
                            ...
                            <Link href={`protfolio/founder/${data.id}`} className="w-full bg-[#FF6B00] p-2 rounded text-center text-white text-xl font-bold cursor-pointer absolute bottom-0	">
                                Details
                            </Link>
                        </div>
                    )
